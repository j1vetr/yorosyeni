...
- [QR Menu OpenAPI contract](qr-menu-openapi-contract.md) — use PATCH not PUT for updates; /analytics/views spec path; image upload needs confirm endpoint to set public ACL
